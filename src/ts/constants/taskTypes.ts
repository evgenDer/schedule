...
export const TASK_TYPES = {
  ...
  cvhtml: { 
    name: 'cv:html', color: 'geekblue', fontColor: 'geekblue', descriptionBackgroundColor: '#fff', descriptionFontColor: '#000'
  } as ITaskType,
  htmlcssacademy: { 
...
export const TASK_TYPES_FONT_COLOR = [
  '#000000', '#ffffff', '#f00000', '#fff700', '#d9d9d9', '#069718', '#0880a3', '#0037ff', '#d800ff','#760863'
]
